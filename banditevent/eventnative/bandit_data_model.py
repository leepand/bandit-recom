...
def Bandit_decisions_model(prefix, project_id,db):
    if prefix=='null':
        prefix = 'bandit'
    table_name = '{prefix}_{project_id}_decisions'.format(prefix=prefix,project_id= str(project_id))
...
def Bandit_rewards_model(prefix,project_id,db):
    if prefix=='null':
        prefix = 'bandit'
    table_name = '{prefix}_{project_id}_rewards'.format(prefix=prefix,project_id= str(project_id))
